...
<body>
    ...
    <h1 style="text-align:center; color:gray;font-family:calibri">Inscripción y recepción de frentes CEI</h1>
    <div id=boxinicio>
        ...
        <br><br><br>
        <input id="boton" type="submit" name="Aceptar" value="Ingresar">
        </form>
    </div>
</body>
</html>